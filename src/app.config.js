module.exports = {
  ...
  authCookieName:
    process.env.VUE_APP_CONF_ENV === 'prod' ? 'XT_AUTH' : 'XT_AUTH_DEV',
  ...
  sendAuthByDefault: process.env.VUE_APP_CONF_ENV === 'prod',
  ...
  logOnRequestError: !(
    ...
    process.env.VUE_APP_CONF_ENV === 'prod'
  )
}
